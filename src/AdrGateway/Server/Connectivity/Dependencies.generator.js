...
const dependenciesTemplate = Handlebars.compile(fs.readFileSync("src/AdrGateway/Server/Connectivity/DependencyGraph.template.hbs","utf8"))
const connectorTemplate = Handlebars.compile(fs.readFileSync("src/AdrGateway/Server/Connectivity/Connector.template.hbs","utf8"))

let dependencies = yaml.safeLoad(fs.readFileSync("src/AdrGateway/Server/Connectivity/Dependencies.yml","utf8"));
...
fs.writeFileSync("src/AdrGateway/Server/Connectivity/DependencyGraph.generated.ts",dependenciesOutput)

const connectivityOutput = connectorTemplate({dependencies})

fs.writeFileSync("src/AdrGateway/Server/Connectivity/Connector.generated.ts",connectivityOutput)
