...
export const GetConfig = async (configFile?:string):Promise<DhServerConfig> => {
    ...
    const config = convict({
        ...
        oidcConfiguration: {
            ...
            "cdr_arrangement_revocation_endpoint": {env: 'DH_OIDC_ARRANGEMENT_ENDPOINT', default: 'https://localhost:10202/idp/arrangement',format:'url', doc: 'Where the cdr_arrangement_revocation_endpoint is served to the ecosystem'},
...
let DefaultOIDCConfiguration: (cfg: DhServerConfig) => OIDCConfiguration = (cfg: DhServerConfig) => {
    let defaults = {
        ...
        "cdr_arrangement_revocation_endpoint": urljoin(cfg.FrontEndMtlsUrl, "idp/arrangement"),
