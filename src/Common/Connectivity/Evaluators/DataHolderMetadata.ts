...
export const GetDataholders = async (cert: ClientCertificateInjector, $:{AdrConnectivityConfig:AdrConnectivityConfig, RegisterAccessCredentials:AccessToken}): Promise<DataHolderRegisterMetadata[]> => {
